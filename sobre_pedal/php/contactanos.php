...
<body class="fondo" >
	...
	<div class="jumbotron login animated zoomIn delay-0s " >
		...
		<form action="../php2/contacto.php" method="post">

	  <div class="form-group">
	    <label for="exampleInputEmail1">Danos tu nombre</label>
	...
	<?php
			...
			echo "<br>" . "<div style='background-color:rgba(252,112,0,0.8);' ' class='btn  w-100'>el correo a sido enviado </div>";
		}
		?>
